...
const ArticleCard = ({ article }) => (
  <div className="overflow-hidden flex flex-col cursor-pointer hover:scale-[1.02] transition-transform duration-300 hover:rounded-lg Shadow dark-Shadow ease-in-out">
