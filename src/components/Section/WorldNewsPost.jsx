  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-3">
        ...
        <Link href={"#"} className="lg:col-span-2 py-2 hover:rounded-lg Shadow hover:scale-[1.02] transition-transform duration-300 ease-in-out overflow-hidden flex flex-col">
